...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class OrgSpringframeworkSecuritySpringSecurityOauth2LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>client</b> with <b>org.springframework.security:spring-security-oauth2-client</b> coordinates and
         * with version reference <b>org.springframework.security.spring.security.oauth2.client</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getClient() {
            return create("org.springframework.security.spring.security.oauth2.client");
        }
    ...
    public static class ComH2databaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>com.h2database.h2</b> with value <b>2.1.212</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class IoJsonwebtokenJjwtVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>io.jsonwebtoken.jjwt.api</b> with value <b>0.11.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>io.jsonwebtoken.jjwt.impl</b> with value <b>0.11.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>io.jsonwebtoken.jjwt.jackson</b> with value <b>0.11.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MysqlMysqlConnectorVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mysql.mysql.connector.java</b> with value <b>8.0.29</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkBootSpringBootStarterVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.boot.spring.boot.starter.security</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>org.springframework.boot.spring.boot.starter.validation</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkBootSpringBootStarterOauth2VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.boot.spring.boot.starter.oauth2.client</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkBootSpringBootStarterOauth2ResourceVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.boot.spring.boot.starter.oauth2.resource.server</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkSecurityOauthBootSpringSecurityOauth2VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.security.oauth.boot.spring.security.oauth2.autoconfigure</b> with value <b>2.1.1.RELEASE</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkSecuritySpringSecurityVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.security.spring.security.config</b> with value <b>5.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>org.springframework.security.spring.security.test</b> with value <b>5.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgSpringframeworkSecuritySpringSecurityOauth2VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.springframework.security.spring.security.oauth2.client</b> with value <b>5.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getClient() { return getVersion("org.springframework.security.spring.security.oauth2.client"); }

        /**
         * Version alias <b>org.springframework.security.spring.security.oauth2.jose</b> with value <b>5.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
